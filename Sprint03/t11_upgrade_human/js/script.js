...
class Superhero extends Human{
    fly() {
        ...
        setTimeout(()=> {
            ...
            document.querySelector('img').src = 'assets/images/7.gif';
        }, 10000);
    }
    fight () {
...
document.querySelector('img').src = 'assets/images/1.gif';
...
function hero() {
    if(human.hero === false) {
        if(human.calories > 500) {
            setFirstName("Iron Man");
            setLastName("");
            superhero.hero = true;
            human.hero = true;
            superhero.calories = human.calories;
            document.querySelector('#info').innerHTML = "Iron Man!";
            document.querySelector('img').src = 'assets/images/3.gif';
...
function sleep() {
    if (superhero.hero === false) {
        document.querySelector('img').src = 'assets/images/5.gif';
        disableButtons();
        human.sleepFor();
        setTimeout(() => {
...
function fly() {
    document.querySelector('img').src = 'assets/images/4.gif';
    superhero.fly();
    disableButtons();
    setTimeout(() => {
        document.querySelector('img').src = 'assets/images/7.gif'
...
function fight() {
    document.querySelector('img').src = 'assets/images/6.gif';
    superhero.fight();
    disableButtons();
    setTimeout(() => {
        document.querySelector('img').src = 'assets/images/7.gif'
...
function setFirstName(name) {
    ...
    if(name === undefined) {
        while(firstName.innerText === "" || firstName.innerText === null) {
            firstName.innerText = prompt("What's the FIRST name of your hero?", "Tony");
...
function setLastName(name) {
    ...
    if(name === undefined) {
        while(lastName.innerText === "" || lastName.innerText === null) {
            lastName.innerText = prompt("What's the LAST name of your hero?", "Stark");
            let regex = RegExp('^[a-zA-Z]+$');
...
function setAge() {
    ...
    while(age.innerText === "" || age.innerText === null) {
        age.innerText = prompt("What's the age of your hero?", "51");
